...
def run_pipeline(db: Session, top_n: int = 5) -> dict:
    """Full pipeline: fetch new videos, rank them, extract insights from top N."""
    ...
    # Step 3: Extract insights from unprocessed top videos
    processed = 0
    already = 0
    for video in ranked:
        if video.processed:
